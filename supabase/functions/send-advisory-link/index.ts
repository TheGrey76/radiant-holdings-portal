                      ...
                      <tr>
                        <td style="padding: 40px 30px;">
                          ...
                          <p style="color: #444; font-size: 16px; line-height: 1.6; margin: 0 0 30px 0;">
                            Un nuovo documento è stato preparato per Lei:
                          </p>
                          
                          <div style="background-color: #f8f8f8; border-left: 4px solid #d4af37; padding: 20px; margin: 0 0 30px 0;">
                            <p style="color: #1a1a2e; font-size: 18px; font-weight: 500; margin: 0;">
                              ${document_title}
                            </p>
                          </div>
                          ...
                          <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                              <td align="center" style="padding: 20px 0;">
                                <a href="${documentUrl}" style="display: inline-block; background-color: #d4af37; color: #1a1a2e; text-decoration: none; padding: 15px 40px; font-size: 16px; font-weight: 500; border-radius: 4px; letter-spacing: 1px;">
                          ...
                          <p style="color: #666; font-size: 14px; line-height: 1.6; margin: 30px 0 0 0;">
                            Per accedere al documento, utilizzi l'indirizzo email a cui è stata inviata questa comunicazione.
                          </p>
                        </td>
                      </tr>
                      ...
                      <tr>
                        <td style="background-color: #1a1a2e; padding: 25px 30px; text-align: center;">
                          <p style="color: #888; font-size: 12px; margin: 0; line-height: 1.6;">
                            © ${new Date().getFullYear()} Aries76 Capital Advisors Ltd.<br>
                            London | Milan
                          </p>
                        </td>
                      </tr>
