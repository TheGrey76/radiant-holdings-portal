...
const Navbar = () => {
  ...
  const menuStructure = {
    ...
    insights: [
      ...
      { name: 'Bitcoin Dynamic Allocation', path: '/bitcoin-dynamic-allocation-preview' },
  ...
  const mobileLinks = [
    ...
    { name: 'Bitcoin Dynamic Allocation', path: '/bitcoin-dynamic-allocation-preview', indent: true },
