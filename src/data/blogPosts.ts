...
export const blogPosts: BlogPost[] = [
  ...
  {
    title: "Cross-Border Fund Structuring: Navigating European Private Markets",
    excerpt: "A comprehensive guide to structuring private equity funds across European jurisdictions, exploring regulatory considerations and optimal structures for pan-European strategies.",
