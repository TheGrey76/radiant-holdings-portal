...
import { Building2, Users, TrendingUp, Globe2, Network, Brain, Shield, Zap, Flame, ArrowUp, ArrowRight, Minus, Download } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a href="/aries76-pe-presentation.pdf" download="Aries76_Private_Equity_Presentation.pdf">
                <Button 
                  size="lg" 
