...
const targetGPs: TargetGP[] = [
  ...
  // GPs from IPEM Paris Database
  {
    name: "Qualium Investissement",
    hqCountry: "France",
    hqCity: "Paris",
    primaryStrategy: "Growth PE",
    sizeBucket: "Mid-cap",
    ariesAngle: "French growth equity investor with focus on technology and innovation.",
    website: "https://www.qualium-investissement.com",
    linkedinUrl: "https://linkedin.com/company/qualium-investissement",
    decisionMaker: "Moumen Abdel Mawlla (Investor Relations)"
  },
  {
    ...
    primaryStrategy: "Growth PE",
    sizeBucket: "Mid-cap",
    ariesAngle: "French growth capital firm focused on mid-market companies.",
    website: "https://www.capitalcroissance.fr",
    linkedinUrl: "https://linkedin.com/company/capital-croissance",
    decisionMaker: "Mohamed Abdesslam (Managing Partner)"
  },
  {
    name: "RCP Advisors",
    hqCountry: "United States",
    hqCity: "New York",
    primaryStrategy: "Multi-strategy PE",
    sizeBucket: "Mid-cap",
    ariesAngle: "US-based PE firm with diversified investment approach.",
    website: "https://rcpadvisors.com",
    linkedinUrl: "https://linkedin.com/company/rcp-advisors",
    decisionMaker: "Alex Abell (Managing Partner)"
  },
  {
    name: "IDICO",
    hqCountry: "France",
    hqCity: "Paris",
    primaryStrategy: "Infrastructure & Growth",
    sizeBucket: "Mid-cap",
    ariesAngle: "French infrastructure and growth capital investor.",
    website: "https://idico.fr/",
    linkedinUrl: "https://linkedin.com/company/idico",
    decisionMaker: "Benjamin Arm (CEO)"
  },
  {
    name: "Supernova Invest VC",
    hqCountry: "France",
    hqCity: "Paris",
    primaryStrategy: "Venture Capital",
    sizeBucket: "Small-cap",
    ariesAngle: "French VC focused on early-stage technology companies.",
    website: "https://supernovainvest.com/",
    linkedinUrl: "https://linkedin.com/company/supernova-invest",
    decisionMaker: "Maxime Alazet (Communications Director)"
  },
  {
    name: "Revaia",
    hqCountry: "France",
    ...
    primaryStrategy: "Growth Equity",
    sizeBucket: "Mid-cap",
    ariesAngle: "French growth equity firm with European focus.",
    website: "https://revaia.com/",
    linkedinUrl: "https://linkedin.com/company/revaia",
    decisionMaker: "Alice Albizzati (Founding Partner)"
  },
  {
    name: "Portobello Capital",
    hqCountry: "Spain",
    hqCity: "Madrid",
    primaryStrategy: "Mid-market Buyout",
    sizeBucket: "Mid-cap",
    ariesAngle: "Leading Spanish mid-market PE firm.",
    website: "https://www.portobellocapital.es",
    linkedinUrl: "https://linkedin.com/company/portobello-capital",
    decisionMaker: "Sabrina Aldana (Head of Client Relations)"
  },
  {
    name: "Kelso & Co.",
    hqCountry: "United States",
    hqCity: "New York",
    primaryStrategy: "Middle Market Buyout",
    sizeBucket: "Mid-cap",
    ariesAngle: "US middle-market PE firm with long track record.",
    website: "https://www.kelso.com",
    linkedinUrl: "https://linkedin.com/company/kelso-and-company",
    decisionMaker: "Lynn Alexander (Head of IR & Fundraising)"
  },
  {
    name: "SHS Capital",
    hqCountry: "Germany",
    hqCity: "Munich",
    primaryStrategy: "Healthcare VC/Growth",
    sizeBucket: "Small-cap",
    ariesAngle: "German healthcare-focused VC and growth equity investor.",
    website: "https://www.shs-capital.eu/",
    linkedinUrl: "https://linkedin.com/company/shs-capital",
    decisionMaker: "Sascha Alilovic (Managing Partner)"
  },
  {
    name: "Clearlake Capital Group",
    hqCountry: "United States",
    hqCity: "Los Angeles",
    primaryStrategy: "Technology & Industrial PE",
    sizeBucket: "Large-cap",
    ariesAngle: "Leading US PE firm focused on technology and industrials.",
    website: "https://clearlake.com",
    linkedinUrl: "https://linkedin.com/company/clearlake-capital-group",
    decisionMaker: "Ayman Ahmed (VP Investor Relations)"
  },
  {
    name: "Coller Capital",
    hqCountry: "United Kingdom",
    hqCity: "London",
    primaryStrategy: "Secondaries",
    sizeBucket: "Large-cap",
    ariesAngle: "Global leader in private equity secondaries.",
    website: "https://www.collercapital.com",
    linkedinUrl: "https://linkedin.com/company/coller-capital",
    decisionMaker: "Jonathan Aiach (Head of Southern Europe)"
  },
  {
    name: "Vauban Infrastructure Partners",
    hqCountry: "France",
    hqCity: "Paris",
    primaryStrategy: "Infrastructure",
    sizeBucket: "Mid-cap",
    ariesAngle: "French infrastructure investment specialist.",
    website: "https://www.vauban-ip.com",
    linkedinUrl: "https://linkedin.com/company/vauban-infrastructure-partners",
    decisionMaker: "Rayan Akkari (Investor Relations)"
  },
  {
    ...
    primaryStrategy: "Early-stage VC",
    sizeBucket: "Small-cap",
    ariesAngle: "French VC backing innovative founders from inception.",
    website: "https://foundersfuture.com/",
    linkedinUrl: "https://linkedin.com/company/founders-future",
    decisionMaker: "Guillaume Ambar (Head of IR)"
  },
  {
    name: "Five Arrows (Rothschild)",
    hqCountry: "France",
    hqCity: "Paris",
    primaryStrategy: "Multi-strategy PE",
    sizeBucket: "Large-cap",
    ariesAngle: "Rothschild's private equity investment arm.",
    website: "https://www.rothschildandco.com/",
    linkedinUrl: "https://linkedin.com/company/five-arrows",
    decisionMaker: "Olivier Baron (Fund Partner)"
  },
  {
    name: "TAG Partners",
    hqCountry: "France",
    ...
    primaryStrategy: "Growth Equity",
    sizeBucket: "Small-cap",
    ariesAngle: "French growth equity firm focused on tech and services.",
    website: "https://www.tagpartners.fr",
    linkedinUrl: "https://linkedin.com/company/tag-partners",
    decisionMaker: "Georges-Alexandre Ancenys (Managing Partner)"
  },
  {
    name: "Oaktree Capital Management",
    hqCountry: "United States",
    hqCity: "Los Angeles",
    primaryStrategy: "Distressed & Credit",
    sizeBucket: "Mega",
    ariesAngle: "Global leader in alternative credit and distressed investing.",
    website: "https://www.oaktreecapital.com/",
    linkedinUrl: "https://linkedin.com/company/oaktree-capital-management",
    decisionMaker: "Julie Anderson (VP Corporate Communications)"
  },
  {
    name: "Audacia",
    hqCountry: "France",
    ...
    primaryStrategy: "Mid-market Buyout",
    sizeBucket: "Mid-cap",
    ariesAngle: "French mid-market PE firm with sector expertise.",
    website: "http://www.audacia.fr",
    linkedinUrl: "https://linkedin.com/company/audacia",
    decisionMaker: "Romain Andrieu-Guitrancourt (Head of IR)"
  },
  {
    name: "Wendel Group",
    hqCountry: "France",
    hqCity: "Paris",
    primaryStrategy: "Listed PE / Multi-strategy",
    sizeBucket: "Large-cap",
    ariesAngle: "Historic French investment company with PE focus.",
    website: "https://www.wendelgroup.com",
    linkedinUrl: "https://linkedin.com/company/wendel",
    decisionMaker: "Christine Anglade (Director ESG & Communications)"
  },
  {
    name: "Quilvest Capital Partners",
    hqCountry: "France",
    hqCity: "Paris",
    primaryStrategy: "Multi-strategy PE",
    sizeBucket: "Mid-cap",
    ariesAngle: "Family office-backed PE firm with European focus.",
    website: "https://www.quilvestcapital.com/",
    linkedinUrl: "https://linkedin.com/company/quilvest-capital-partners",
    decisionMaker: "Charles Aponso (Partner)"
  },
  {
    name: "HCapital Partners",
    hqCountry: "Portugal",
    hqCity: "Lisbon",
    primaryStrategy: "Mid-market Buyout",
    sizeBucket: "Small-cap",
    ariesAngle: "Leading Portuguese mid-market PE firm.",
    website: "https://www.hcapital.pt",
    linkedinUrl: "https://linkedin.com/company/hcapital-partners",
    decisionMaker: "João Arantes Oliveira (Managing Partner)"
  },
  {
    ...
    primaryStrategy: "Infrastructure",
    sizeBucket: "Large-cap",
    ariesAngle: "Leading European infrastructure investment specialist.",
    website: "https://www.antin-ip.com",
    linkedinUrl: "https://linkedin.com/company/antin-infrastructure-partners",
    decisionMaker: "Shana Arbel (Investor Relations Analyst)"
  },
  {
    name: "LBP AM",
    hqCountry: "France",
    hqCity: "Paris",
    primaryStrategy: "Infrastructure & Private Debt",
    sizeBucket: "Mid-cap",
    ariesAngle: "French asset manager with infrastructure and private debt expertise.",
    website: "https://www.lbpam.com",
    linkedinUrl: "https://linkedin.com/company/lbp-am",
    decisionMaker: "Peter Arnold (Head of European Private Assets)"
  },
  {
    name: "3VC",
    hqCountry: "Austria",
    ...
    primaryStrategy: "Early-stage VC",
    sizeBucket: "Small-cap",
    ariesAngle: "Austrian VC focused on early-stage tech companies.",
    website: "https://three.vc/",
    linkedinUrl: "https://linkedin.com/company/3vc",
    decisionMaker: "Eva Arh (GP)"
  },
  {
    name: "Pantheon",
    hqCountry: "United Kingdom",
    hqCity: "London",
    primaryStrategy: "Funds of Funds / Secondaries",
    sizeBucket: "Large-cap",
    ariesAngle: "Global leader in fund of funds and secondaries.",
    website: "https://www.pantheon.com/",
    linkedinUrl: "https://linkedin.com/company/pantheon",
    decisionMaker: "Carlos Arias (Principal)"
  },
  {
    name: "Arev Partners",
    hqCountry: "France",
    ...
    primaryStrategy: "Venture Capital",
    sizeBucket: "Small-cap",
    ariesAngle: "French VC focused on technology and innovation.",
    website: "https://arevpartners.com/en/home/",
    linkedinUrl: "https://linkedin.com/company/arev-partners",
    decisionMaker: "Patrick Aris (Investment Manager)"
  },
  {
    name: "Federated Hermes Private Markets",
    hqCountry: "United Kingdom",
    hqCity: "London",
    primaryStrategy: "Multi-strategy PE",
    sizeBucket: "Large-cap",
    ariesAngle: "Global private markets platform with diversified strategies.",
    website: "https://www.federatedhermes.com/private-markets",
    linkedinUrl: "https://linkedin.com/company/federated-hermes",
    decisionMaker: "Stefan Arneth (Sales Director DACH)"
  },
  {
    name: "Monroe Capital",
    hqCountry: "United States",
    hqCity: "Chicago",
    primaryStrategy: "Alternative Credit",
    sizeBucket: "Mid-cap",
    ariesAngle: "US private credit specialist with middle-market focus.",
    website: "https://www.monroecap.com",
    linkedinUrl: "https://linkedin.com/company/monroe-capital",
    decisionMaker: "Kyle Asher (Co-Head Alternative Credit)"
  },
  {
    name: "Blackstone",
    hqCountry: "United States",
    hqCity: "New York",
    primaryStrategy: "Multi-asset PE / Real Estate / Credit",
    sizeBucket: "Mega",
    ariesAngle: "World's largest alternative asset manager.",
    website: "http://www.blackstone.com",
    linkedinUrl: "https://linkedin.com/company/blackstone",
    decisionMaker: "Lionel Assant (Global Co-CIO)"
  },
  {
    ...
    primaryStrategy: "Small Buyout",
    sizeBucket: "Small-cap",
    ariesAngle: "French small-cap buyout specialist.",
    website: "https://www.ixope.fr",
    linkedinUrl: "https://linkedin.com/company/ixo-private-equity",
    decisionMaker: "Olivier Athanase (President)"
  },
  {
    name: "Sienna Investment Managers",
    hqCountry: "France",
    hqCity: "Paris",
    primaryStrategy: "Private Credit",
    sizeBucket: "Mid-cap",
    ariesAngle: "French private credit specialist.",
    website: "https://www.sienna-im.com",
    linkedinUrl: "https://linkedin.com/company/sienna-investment-managers",
    decisionMaker: "Raphaëlle Atlani (Investor Relations)"
  },
  {
    name: "ING Bank / Riverrock",
    hqCountry: "United Kingdom",
    hqCity: "London",
    primaryStrategy: "Private Debt",
    sizeBucket: "Mid-cap",
    ariesAngle: "ING's private debt platform focused on European mid-market.",
    website: "https://riverrock.eu/",
    linkedinUrl: "https://linkedin.com/company/riverrock",
    decisionMaker: "Meng Hua Aw (MD Investor Relations)"
  },
  {
    name: "Sona Asset Management",
    hqCountry: "United Kingdom",
    hqCity: "London",
    primaryStrategy: "Structured Credit",
    sizeBucket: "Mid-cap",
    ariesAngle: "UK structured credit specialist.",
    website: "https://www.sona-am.com",
    linkedinUrl: "https://linkedin.com/company/sona-asset-management",
    decisionMaker: "Aymeric Paillat (Portfolio Manager)"
  },
  {
    name: "Ambienta",
    hqCountry: "Italy",
    hqCity: "Milan",
    primaryStrategy: "Environmental Sustainability PE",
    sizeBucket: "Mid-cap",
    ariesAngle: "European leader in environmental sustainability-focused PE.",
    website: "https://www.ambientasgr.com",
    linkedinUrl: "https://linkedin.com/company/ambienta",
    decisionMaker: "Mailin Badurina (Investor Relations)"
  },
  {
    ...
    primaryStrategy: "Alternative Credit",
    sizeBucket: "Mid-cap",
    ariesAngle: "Insurance-backed alternative credit platform.",
    website: "https://scor-ip.com",
    linkedinUrl: "https://linkedin.com/company/scor-investment-partners",
    decisionMaker: "Arthur Bagnaud (Senior Institutional Sales)"
  },
  {
    name: "Apheon",
    hqCountry: "France",
    ...
    primaryStrategy: "Mid-market Buyout",
    sizeBucket: "Mid-cap",
    ariesAngle: "French mid-market PE firm with industrial focus.",
    website: "https://www.apheon.com",
    linkedinUrl: "https://linkedin.com/company/apheon",
    decisionMaker: "TBD"
  },
  {
    name: "Carlyle",
    ...
    primaryStrategy: "Multi-strategy PE",
    sizeBucket: "Mega",
    ariesAngle: "Global PE powerhouse with diversified investment strategies.",
    website: "https://www.carlyle.com/",
    linkedinUrl: "https://linkedin.com/company/the-carlyle-group",
    decisionMaker: "Leigh-Ann Bailey (Investor Relations)"
  },
  {
    name: "Greylion Partners",
    hqCountry: "United States",
    hqCity: "New York",
    primaryStrategy: "Lower Middle Market Buyout",
    sizeBucket: "Small-cap",
    ariesAngle: "US lower middle-market specialist.",
    website: "https://www.greylion.com/",
    linkedinUrl: "https://linkedin.com/company/greylion-partners",
    decisionMaker: "Chip Baird (Co-Founder & Managing Partner)"
  },
  {
    name: "C4 Ventures",
    hqCountry: "France",
    ...
    primaryStrategy: "Venture Capital",
    sizeBucket: "Small-cap",
    ariesAngle: "French VC focused on consumer and tech companies.",
    website: "https://c4v.com",
    linkedinUrl: "https://linkedin.com/company/c4-ventures",
    decisionMaker: "Boris Bakech (Managing Partner)"
  },
  {
    name: "Partech",
    hqCountry: "France",
    ...
    primaryStrategy: "Venture Capital",
    sizeBucket: "Mid-cap",
    ariesAngle: "Leading global VC with focus on technology.",
    website: "https://partechpartners.com",
    linkedinUrl: "https://linkedin.com/company/partech",
    decisionMaker: "Vladia Ballesteros (Principal IR)"
  },
  {
    name: "Axcel",
    hqCountry: "Denmark",
    ...
    primaryStrategy: "Mid-market Buyout",
    sizeBucket: "Mid-cap",
    ariesAngle: "Leading Nordic mid-market PE firm.",
    website: "https://www.axcel.com",
    linkedinUrl: "https://linkedin.com/company/axcel",
    decisionMaker: "Christian Bamberger Bro (Partner)"
  },
  {
    name: "TPG Capital",
    hqCountry: "United States",
    ...
    primaryStrategy: "Multi-strategy PE",
    sizeBucket: "Mega",
    ariesAngle: "Global alternative asset firm with diverse strategies.",
    website: "https://www.tpg.com",
    linkedinUrl: "https://linkedin.com/company/tpg",
    decisionMaker: "Stephen Bamford (Partner Capital Formation)"
  },
  {
    name: "Avant Bio",
    hqCountry: "United States",
    hqCity: "Boston",
    primaryStrategy: "Life Sciences VC",
    sizeBucket: "Small-cap",
    ariesAngle: "US life sciences venture capital specialist.",
    website: "https://www.avant.bio",
    linkedinUrl: "https://linkedin.com/company/avant-bio",
    decisionMaker: "Ole Henrik Bang-Andreasen (Principal)"
  },
  {
    name: "Latour Capital",
    hqCountry: "France",
    ...
    sizeBucket: "Small-cap",
    ariesAngle: "French small-cap buyout specialist.",
    website: "https://www.latour-capital.fr",
    linkedinUrl: "https://linkedin.com/company/latour-capital",
    decisionMaker: "Cédric Bannel (Founding Partner)"
  },
  {
    name: "Sagard",
    hqCountry: "France",
    ...
    primaryStrategy: "Multi-strategy PE",
    sizeBucket: "Mid-cap",
    ariesAngle: "European PE firm with diversified investment approach.",
    website: "https://www.sagard.com/",
    linkedinUrl: "https://linkedin.com/company/sagard",
    decisionMaker: "Bérangère Barbe (Partner)"
  },
  {
    name: "Hellman & Friedman",
    hqCountry: "United States",
    hqCity: "San Francisco",
    primaryStrategy: "Large-cap Buyout",
    sizeBucket: "Mega",
    ariesAngle: "Premier US large-cap PE firm.",
    website: "https://www.hf.com",
    linkedinUrl: "https://linkedin.com/company/hellman-friedman",
    decisionMaker: "Catie Barile (Director)"
  }
];
