...
import { Mail, Calendar, Shield, Users, TrendingUp, Target, CheckCircle, FileText, Download, AlertCircle, Award, Briefcase, Globe, ChevronRight, Star } from 'lucide-react';
...
const ForLimitedPartners = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Stats Section */}
      <section className="py-20 bg-gradient-to-br from-primary via-primary-deep to-primary text-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            >
              ...
              <div className="text-white/80 font-light">Years Combined Experience</div>
            </motion.div>
            ...
            <motion.div
              ...
              className="text-center"
            >
              <div className="text-5xl md:text-6xl font-light mb-2">€2B+</div>
              <div className="text-white/80 font-light">Capital Raised</div>
            </motion.div>
            ...
            >
              ...
              <div className="text-white/80 font-light">LP Relationships</div>
            </motion.div>
            ...
            <motion.div
              ...
              className="text-center"
            >
              <div className="text-5xl md:text-6xl font-light mb-2">10+</div>
              <div className="text-white/80 font-light">Active Mandates</div>
            </motion.div>
          </div>
        </div>
      </section>
              ...
              <Card className="h-full border-border/50 hover:border-accent/50 transition-colors">
                <CardContent className="pt-6">
                  ...
                  <p className="text-muted-foreground font-light mb-4 italic">
                    "Aries76 brought us access to niche European private equity strategies that perfectly matched our mandate. Their independent approach and transparency set them apart."
                  </p>
                  <div>
                    <p className="font-medium text-foreground">Roberto M.</p>
                    <p className="text-sm text-muted-foreground">CIO, Multi-Family Office</p>
                  </div>
                </CardContent>
              </Card>
            </motion.div>
            ...
            >
              <Card className="h-full border-border/50 hover:border-accent/50 transition-colors">
                <CardContent className="pt-6">
                  ...
                  <p className="text-muted-foreground font-light mb-4 italic">
                    "Working with Aries76 has been transformative for our private markets portfolio. Their data-driven insights and curated GP relationships have consistently delivered value."
                  </p>
                  <div>
                    <p className="font-medium text-foreground">Sarah L.</p>
                    <p className="text-sm text-muted-foreground">Head of Alternatives, Private Bank</p>
                  </div>
                </CardContent>
              </Card>
            </motion.div>
            ...
            >
              <Card className="h-full border-border/50 hover:border-accent/50 transition-colors">
                <CardContent className="pt-6">
                  ...
                  <p className="text-muted-foreground font-light mb-4 italic">
                    "The team's deep understanding of institutional LP requirements and their long-term partnership mindset make them a trusted advisor for our private equity allocations."
                  </p>
                  <div>
                    <p className="font-medium text-foreground">Marco V.</p>
                    <p className="text-sm text-muted-foreground">Investment Director, Pension Fund</p>
                  </div>
                </CardContent>
              </Card>
            </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground font-light mb-8 max-w-2xl mx-auto">
              Join our network of professional investors and gain access to curated private markets strategies.
            </p>
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                <AccordionTrigger className="text-left">
                  <span className="font-light text-lg">Who can invest through Aries76?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground font-light">
                  Aries76 exclusively works with professional and institutional investors: family offices, multi-family offices, private banks, wealth managers, independent advisory firms, pension funds, insurance companies, and other qualified institutional LPs. We do not operate as a retail distributor.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-2">
                <AccordionTrigger className="text-left">
                  <span className="font-light text-lg">What types of investment opportunities do you provide access to?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground font-light">
                  We provide access to selected private equity funds, co-investments, club deals, and bespoke structured solutions. Our focus is on European private equity strategies, thematic opportunities (digital infrastructure, impact, healthcare, technology), and tailored single-asset vehicles designed for specific investor requirements.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-3">
                <AccordionTrigger className="text-left">
                  <span className="font-light text-lg">How does Aries76's fee structure work?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground font-light">
                  We operate on a transparent mandate basis with fees paid by the GPs we represent. There are no fees charged directly to LPs for introductions or due diligence support. We maintain complete transparency about our commercial arrangements and potential conflicts of interest.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-4">
                <AccordionTrigger className="text-left">
                  <span className="font-light text-lg">What is the typical minimum commitment size?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground font-light">
                  Minimum commitment sizes vary by strategy and fund. Typically, primary fund commitments range from €1m to €5m, though bespoke structures can be tailored to specific LP requirements. We work with LPs to understand their allocation constraints and identify suitable opportunities.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-5">
                <AccordionTrigger className="text-left">
                  <span className="font-light text-lg">How do you select the GPs and strategies you work with?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground font-light">
                  We apply rigorous selection criteria focused on team excellence, strategy clarity, track record quality, and alignment of interests. We work with a limited number of mandates to ensure deep knowledge and maintain quality. Our focus is on long-term value creation and transparency.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-6">
                <AccordionTrigger className="text-left">
                  <span className="font-light text-lg">What support do you provide during the due diligence process?</span>
                </AccordionTrigger>
                <AccordionContent className="text-muted-foreground font-light">
                  We provide comprehensive information packs, facilitate management meetings and site visits, coordinate Q&A processes, and support your internal due diligence workflows. While we provide information and access, all investment decisions remain entirely with the LP. We can also coordinate with your legal and tax advisors as needed.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </motion.div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-light text-foreground mb-6 tracking-tight">
              Your journey with Aries76
            </h2>
            <p className="text-lg text-muted-foreground font-light max-w-3xl mx-auto">
              A simple, transparent process from initial contact to investment
            </p>
          </motion.div>
            ...
            >
              <Card className="h-full border-border/50 hover:border-accent/50 transition-colors">
                <CardContent className="pt-6">
                  ...
                  <h3 className="text-lg font-light text-foreground mb-2 text-center">Initial Contact</h3>
                  <p className="text-sm text-muted-foreground font-light text-center">
                    Reach out via email or schedule an introductory call to discuss your investment criteria
                  </p>
                </CardContent>
              </Card>
              <ChevronRight className="hidden md:block absolute top-1/2 -right-3 transform -translate-y-1/2 h-6 w-6 text-accent" />
            </motion.div>
            ...
            >
              <Card className="h-full border-border/50 hover:border-accent/50 transition-colors">
                <CardContent className="pt-6">
                  ...
                  <h3 className="text-lg font-light text-foreground mb-2 text-center">Strategy Alignment</h3>
                  <p className="text-sm text-muted-foreground font-light text-center">
                    We present curated opportunities that match your mandate and risk appetite
                  </p>
                </CardContent>
              </Card>
              <ChevronRight className="hidden md:block absolute top-1/2 -right-3 transform -translate-y-1/2 h-6 w-6 text-accent" />
            ...
            >
              <Card className="h-full border-border/50 hover:border-accent/50 transition-colors">
                <CardContent className="pt-6">
                  ...
                  <h3 className="text-lg font-light text-foreground mb-2 text-center">Due Diligence</h3>
                  <p className="text-sm text-muted-foreground font-light text-center">
                    Access documents, meet the GP team, and conduct your internal review process
                  </p>
                </CardContent>
              </Card>
              <ChevronRight className="hidden md:block absolute top-1/2 -right-3 transform -translate-y-1/2 h-6 w-6 text-accent" />
            ...
            >
              <Card className="h-full border-border/50 hover:border-accent/50 transition-colors">
                <CardContent className="pt-6">
                  ...
                  <h3 className="text-lg font-light text-foreground mb-2 text-center">Investment & Partnership</h3>
                  <p className="text-sm text-muted-foreground font-light text-center">
                    Complete your commitment and begin a long-term partnership with Aries76
                  </p>
                </CardContent>
              </Card>
            </motion.div>
