        ...
        <div className="container max-w-7xl mx-auto px-6 pb-24">
          ...
          <ChapterSection id="chapter-10" dataSection="chapter-10">
            ...
            <div className="prose prose-lg max-w-none space-y-8">
              ...
              {/* ===== SECTION 6: MODEL DASHBOARD – CURRENT QUARTER ===== */}
                ...
                <div className="space-y-8">
                  <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                      ...
                      <h2 className="text-3xl md:text-4xl font-bold text-foreground">Model Dashboard – Q1 2026</h2>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-4 mb-8">
                    <div className="px-4 py-2 rounded-lg bg-muted/50 border border-border/40">
                      ...
                      <span className="ml-2 text-sm font-medium text-foreground">January 15, 2026</span>
                    </div>
                    <div className="px-4 py-2 rounded-lg bg-muted/50 border border-border/40">
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 rounded-xl bg-gradient-to-br from-emerald-500/10 to-emerald-500/5 border-2 border-emerald-500/30">
                      <h4 className="text-lg font-bold text-foreground mb-2">Conservative Model</h4>
                      <p className="text-sm text-muted-foreground mb-4">Exposure control focus</p>
                      <div className="text-4xl font-bold text-emerald-400 mb-2">5%</div>
                      <p className="text-xs text-emerald-400/70">Current allocation</p>
                      <div className="mt-4 pt-4 border-t border-emerald-500/20">
                        <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-emerald-400/20 text-emerald-400 border border-emerald-400/30">
                          Low Exposure
                        </span>
                      </div>
                    </div>

                    <div className="p-6 rounded-xl bg-gradient-to-br from-amber-500/10 to-amber-500/5 border-2 border-amber-500/30">
                      <h4 className="text-lg font-bold text-foreground mb-2">Balanced Model</h4>
                      <p className="text-sm text-muted-foreground mb-4">Cycle-aware participation</p>
                      <div className="text-4xl font-bold text-amber-400 mb-2">12%</div>
                      <p className="text-xs text-amber-400/70">Current allocation</p>
                      <div className="mt-4 pt-4 border-t border-amber-500/20">
                        <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-amber-400/20 text-amber-400 border border-amber-400/30">
                          Medium Exposure
                        </span>
                      </div>
                    </div>

                    <div className="p-6 rounded-xl bg-gradient-to-br from-orange-500/10 to-orange-500/5 border-2 border-orange-500/30">
                      <h4 className="text-lg font-bold text-foreground mb-2">Aggressive Model</h4>
                      <p className="text-sm text-muted-foreground mb-4">Asymmetric long-term exposure</p>
                      <div className="text-4xl font-bold text-orange-400 mb-2">25%</div>
                      <p className="text-xs text-orange-400/70">Current allocation</p>
                      <div className="mt-4 pt-4 border-t border-orange-500/20">
                        <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-orange-400/20 text-orange-400 border border-orange-400/30">
                          High Exposure
                        </span>
                      </div>
                    </div>
                    ...
                    <table className="w-full border-collapse">
                      <thead>
                        <tr className="border-b-2 border-primary/30">
                          ...
                          <th className="text-center py-4 px-4 text-sm font-bold text-emerald-400">Conservative</th>
                          <th className="text-center py-4 px-4 text-sm font-bold text-amber-400">Balanced</th>
                          <th className="text-center py-4 px-4 text-sm font-bold text-orange-400">Aggressive</th>
                        </tr>
                      </thead>
                      <tbody className="divide-y divide-border/40">
                        <tr className="hover:bg-muted/30 transition-colors">
                          <td className="py-4 px-4 text-sm text-foreground font-medium">Current Allocation (%)</td>
                          <td className="py-4 px-4 text-center text-sm text-emerald-400 font-semibold">5%</td>
                          <td className="py-4 px-4 text-center text-sm text-amber-400 font-semibold">12%</td>
                          <td className="py-4 px-4 text-center text-sm text-orange-400 font-semibold">25%</td>
                        </tr>
                        <tr className="hover:bg-muted/30 transition-colors">
                          <td className="py-4 px-4 text-sm text-foreground font-medium">Historical Range</td>
                          <td className="py-4 px-4 text-center text-sm text-muted-foreground">0% – 10%</td>
                          <td className="py-4 px-4 text-center text-sm text-muted-foreground">5% – 20%</td>
                          <td className="py-4 px-4 text-center text-sm text-muted-foreground">10% – 40%</td>
                        </tr>
                        <tr className="hover:bg-muted/30 transition-colors">
                          <td className="py-4 px-4 text-sm text-foreground font-medium">Distance from Mean</td>
                          <td className="py-4 px-4 text-center text-sm text-muted-foreground">At mean</td>
                          <td className="py-4 px-4 text-center text-sm text-muted-foreground">-0.5σ</td>
                          <td className="py-4 px-4 text-center text-sm text-muted-foreground">+0.3σ</td>
                        </tr>
                        <tr className="hover:bg-muted/30 transition-colors">
                          <td className="py-4 px-4 text-sm text-foreground font-medium">Current Regime</td>
                          <td className="py-4 px-4 text-center">
                            <span className="px-2 py-1 rounded-full text-xs font-medium bg-emerald-400/20 text-emerald-400">Neutral</span>
                          </td>
                          <td className="py-4 px-4 text-center">
                            <span className="px-2 py-1 rounded-full text-xs font-medium bg-amber-400/20 text-amber-400">Expansion</span>
                          </td>
                          <td className="py-4 px-4 text-center">
                            <span className="px-2 py-1 rounded-full text-xs font-medium bg-orange-400/20 text-orange-400">Expansion</span>
                          </td>
                        </tr>
                      </tbody>
                    </table>
              ...
              {/* ===== SECTION 8: TARGETS 2026 – DYNAMIC RANGES ===== */}
              <ChapterSection id="dynamic-ranges" dataSection="dynamic-ranges">
                <div className="space-y-8">
                  ...
                  {/* Target Ranges Grid */}
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 rounded-xl bg-card border-2 border-emerald-500/30">
                      <h4 className="text-lg font-bold text-emerald-400 mb-4">Conservative Model</h4>
                      <div className="space-y-4">
                        <div>
                          <p className="text-xs text-muted-foreground uppercase tracking-wider">Target Range</p>
                          <p className="text-2xl font-bold text-foreground">$85,000 – $120,000</p>
                        </div>
                        <div>
                          <p className="text-xs text-muted-foreground uppercase tracking-wider">Stress Floor</p>
                          <p className="text-lg font-semibold text-muted-foreground">$52,000</p>
                        </div>
                      </div>
                    </div>

                    <div className="p-6 rounded-xl bg-card border-2 border-amber-500/30">
                      <h4 className="text-lg font-bold text-amber-400 mb-4">Balanced Model</h4>
                      <div className="space-y-4">
                        <div>
                          <p className="text-xs text-muted-foreground uppercase tracking-wider">Target Range</p>
                          <p className="text-2xl font-bold text-foreground">$100,000 – $165,000</p>
                        </div>
                        <div>
                          <p className="text-xs text-muted-foreground uppercase tracking-wider">Stress Floor</p>
                          <p className="text-lg font-semibold text-muted-foreground">$58,000</p>
                        </div>
                      </div>
                    </div>

                    <div className="p-6 rounded-xl bg-card border-2 border-orange-500/30">
                      <h4 className="text-lg font-bold text-orange-400 mb-4">Aggressive Model</h4>
                      <div className="space-y-4">
                        <div>
                          <p className="text-xs text-muted-foreground uppercase tracking-wider">Target Range</p>
                          <p className="text-2xl font-bold text-foreground">$130,000 – $258,000</p>
                        </div>
                        <div>
                          <p className="text-xs text-muted-foreground uppercase tracking-wider">Stress Floor</p>
                          <p className="text-lg font-semibold text-muted-foreground">$65,000</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              {/* ===== SECTION 9: MODEL STATE COMMENTARY ===== */}
                ...
                <div className="space-y-8">
                  ...
                  <div className="p-8 rounded-2xl bg-gradient-to-br from-blue-500/10 to-blue-500/5 border-2 border-blue-500/30">
                    ...
                    <p className="text-foreground/70 leading-relaxed">
                      <strong>Regime classification:</strong> The macro-liquidity framework currently labels the environment as "Expansion" based on global M2 growth exceeding 8% YoY and real rates remaining below historical averages. This classification does not imply that Bitcoin will rise—it describes the structural backdrop within which the models operate.
                    </p>
                  </div>
              ...
              {/* ===== SECTION 10: METHODOLOGY & DISCLAIMERS ===== */}
              <div className="mt-24 p-10 rounded-2xl bg-gradient-to-br from-muted/50 to-muted/30 border-2 border-border/60">
