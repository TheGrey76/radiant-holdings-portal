          ...
          <div className="bg-background">
            <div className="px-0 py-4 mb-6">
              <div className="text-center mb-6">
                <p className="text-xs font-light text-muted-foreground uppercase tracking-widest mb-3">Institutional Research Report</p>
                <h1 className="text-5xl font-light text-foreground mb-2 tracking-tight">
                  Bitcoin 2026
                </h1>
            ...
            <div className="px-0 py-4 space-y-6">
              ...
              <div className="mb-6 pb-4 border-b border-border/20">
                <h2 className="text-xl font-light text-foreground mb-4 tracking-wide">
                  Table of Contents
                </h2>
                <nav className="space-y-1">
                  <a 
                    href="#chapter-1" 
                    className="block text-foreground/70 hover:text-foreground transition-colors py-1.5 text-sm tracking-wide"
                  >
              ...
              <div id="chapter-1" className="scroll-mt-20 mb-6">
                <div className="mb-4">
                  <p className="text-xs font-light text-muted-foreground uppercase tracking-widest mb-2">Chapter I</p>
                  <h2 className="text-4xl font-light text-foreground mb-2 leading-tight tracking-tight">
                    Executive Summary & Macro–Liquidity Regime Analysis
                  </h2>
                </div>
              </div>

              <p className="text-base leading-relaxed text-foreground/80 mb-5 font-light">
              ...
              <figure className="my-5 max-w-4xl mx-auto">
                ...
                <figcaption className="text-xs text-muted-foreground mt-3 text-center font-light tracking-wide">
              ...
              <p className="text-base leading-relaxed text-foreground/70 mb-5 font-light">
