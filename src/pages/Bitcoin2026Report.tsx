      ...
      <div className="min-h-screen bg-zinc-50">
        <div className="container max-w-4xl mx-auto px-8 py-16">
          <div className="bg-white border border-zinc-200 shadow-sm">
            {/* Header */}
            <div className="border-b border-zinc-200 px-12 py-12">
              <div className="space-y-1 mb-8">
                <p className="text-[10px] font-medium text-zinc-500 uppercase tracking-[0.15em]">
                  Institutional Research
                </p>
                <h1 className="text-[42px] font-normal text-zinc-900 tracking-tight leading-none">
                  Bitcoin 2026
                </h1>
                <p className="text-base text-zinc-600 font-light pt-2">
            ...
            <div className="px-12 py-10 space-y-16">
              {/* Table of Contents */}
              <div className="pb-10 mb-10 border-b border-zinc-200">
                <h2 className="text-xs font-medium text-zinc-900 uppercase tracking-[0.15em] mb-6">
                  Contents
                </h2>
                <nav className="space-y-2.5">
                  <a 
                    href="#chapter-1" 
                    className="group flex items-baseline gap-3 text-[13px] text-zinc-600 hover:text-zinc-900 transition-colors"
                  >
                    <span className="font-medium text-zinc-400 group-hover:text-zinc-600">I</span>
                    <span className="flex-1">Executive Summary & Macro–Liquidity Regime Analysis</span>
                  </a>
                  <a 
                    href="#chapter-2" 
                    className="group flex items-baseline gap-3 text-[13px] text-zinc-600 hover:text-zinc-900 transition-colors"
                  >
                    <span className="font-medium text-zinc-400 group-hover:text-zinc-600">II</span>
                    <span className="flex-1">Advanced Price Framework & Quantitative Modelling</span>
                  </a>
                  <a 
                    href="#chapter-3" 
                    className="group flex items-baseline gap-3 text-[13px] text-zinc-600 hover:text-zinc-900 transition-colors"
                  >
                    <span className="font-medium text-zinc-400 group-hover:text-zinc-600">III</span>
                    <span className="flex-1">Advanced On-Chain Intelligence & Market Microstructure</span>
                  </a>
                  <a 
                    href="#chapter-4" 
                    className="group flex items-baseline gap-3 text-[13px] text-zinc-600 hover:text-zinc-900 transition-colors"
                  >
                    <span className="font-medium text-zinc-400 group-hover:text-zinc-600">IV</span>
                    <span className="flex-1">Bitcoin Treasuries, Technology Outlook & Mining Economics</span>
                  </a>
                  <a 
                    href="#chapter-5" 
                    className="group flex items-baseline gap-3 text-[13px] text-zinc-600 hover:text-zinc-900 transition-colors"
                  >
                    <span className="font-medium text-zinc-400 group-hover:text-zinc-600">V</span>
                    <span className="flex-1">Regulatory Outlook 2025–2026</span>
                  </a>
                  <a 
                    href="#chapter-6" 
                    className="group flex items-baseline gap-3 text-[13px] text-zinc-600 hover:text-zinc-900 transition-colors"
                  >
                    <span className="font-medium text-zinc-400 group-hover:text-zinc-600">VI</span>
                    <span className="flex-1">Scenario Analysis for 2026</span>
                  </a>
                  <a 
                    href="#chapter-7" 
                    className="group flex items-baseline gap-3 text-[13px] text-zinc-600 hover:text-zinc-900 transition-colors"
                  >
                    <span className="font-medium text-zinc-400 group-hover:text-zinc-600">VII</span>
                    <span className="flex-1">Bitcoin 2026 Pricing Projection</span>
                  </a>
                  <a 
                    href="#chapter-8" 
                    className="group flex items-baseline gap-3 text-[13px] text-zinc-600 hover:text-zinc-900 transition-colors"
                  >
                    <span className="font-medium text-zinc-400 group-hover:text-zinc-600">VIII</span>
                    <span className="flex-1">Risks and Uncertainties</span>
                  </a>
                  <a 
                    href="#chapter-10" 
                    className="group flex items-baseline gap-3 text-[13px] text-zinc-600 hover:text-zinc-900 transition-colors"
                  >
                    <span className="font-medium text-zinc-400 group-hover:text-zinc-600">X</span>
                    <span className="flex-1">Bitcoin 2026 Target Price</span>
                  </a>
                  <a 
                    href="#chapter-9" 
                    className="group flex items-baseline gap-3 text-[13px] text-zinc-600 hover:text-zinc-900 transition-colors"
                  >
                    <span className="font-medium text-zinc-400 group-hover:text-zinc-600">IX</span>
                    <span className="flex-1">Appendix</span>
                  </a>
                </nav>
              </div>

              <div id="chapter-1" className="scroll-mt-20 space-y-8">
                <div>
                  <div className="flex items-baseline gap-4 mb-4">
                    <span className="text-[11px] font-medium text-zinc-400 uppercase tracking-[0.15em]">Chapter I</span>
                  </div>
                  <h2 className="text-2xl font-normal text-zinc-900 mb-6 leading-snug">
                    Executive Summary & Macro–Liquidity Regime Analysis
                  </h2>
                </div>

                <p className="text-[15px] leading-relaxed text-zinc-700 font-light">
                ...
                <figure className="my-10">
                  ...
                  <figcaption className="text-[11px] text-zinc-500 mt-3 font-light">
                ...
                <h3 className="text-base font-medium text-zinc-900 mt-12 mb-4">
              ...
              <h3 className="text-xl font-light text-foreground mt-6 mb-3 tracking-wide">
              ...
              <div id="chapter-2" className="mb-12 scroll-mt-24">
                <div className="mb-10">
                  <p className="text-xs font-light text-muted-foreground uppercase tracking-widest mb-4">Chapter II</p>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-border/40">
                      <th className="px-6 py-4 text-left font-normal text-foreground tracking-wide">Indicator</th>
                      <th className="px-6 py-4 text-left font-normal text-foreground tracking-wide">Low Regime</th>
                      <th className="px-6 py-4 text-left font-normal text-foreground tracking-wide">Neutral Regime</th>
                      <th className="px-6 py-4 text-left font-normal text-foreground tracking-wide">High Regime</th>
                    </tr>
                  </thead>
                  <tbody className="text-foreground/70">
                    <tr className="border-b border-border/30 hover:bg-muted/10 transition-colors">
                      <td className="px-6 py-4 font-light text-foreground">Perp Funding Rates</td>
