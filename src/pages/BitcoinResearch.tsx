          ...
          <div className="container max-w-6xl mx-auto px-6 py-28 md:py-36 relative z-10">
            ...
            >
              ...
              >
                ...
                <a 
                  href="https://t.me/aries76capital" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#0088cc]/20 border border-[#0088cc]/40 hover:bg-[#0088cc]/30 transition-colors"
                >
                  ...
                  <span className="text-sm font-medium text-[#0088cc]">Daily Updates</span>
                </a>
              </motion.div>
            </motion.div>
          </div>
