    ...
    <div className="min-h-screen bg-gradient-to-b from-background via-background/95 to-background/90 pt-24 pb-16">
      <div className="container max-w-5xl mx-auto px-4">
        ...
        <motion.section
          ...
          className="mb-16"
        >
          <h2 className="text-2xl font-bold mb-6">1. Fee structure for GP fundraising</h2>
          ...
          <div className="space-y-6">
            <Card className="p-6 bg-card/50">
              <h3 className="text-lg font-semibold mb-3">Recurring fee on AUM</h3>
            ...
            <Card className="p-6 bg-card/50">
              <h3 className="text-lg font-semibold mb-3">Success fee on committed capital</h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <Card className="p-6 bg-card/50">
              <h3 className="text-lg font-semibold mb-3">Scope and calculation base</h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <Card className="p-6 bg-card/50">
              <h3 className="text-lg font-semibold mb-3">Duration and tail period</h3>
              <p className="text-muted-foreground leading-relaxed">
        ...
        <motion.section
          ...
          className="mb-16"
        >
          <h2 className="text-2xl font-bold mb-6">2. Mandate complexity assessment model</h2>
          ...
          <p className="text-base font-semibold mb-4">Key assessment dimensions include:</p>
        ...
        <motion.section
          ...
          className="mb-16"
        >
          <h2 className="text-2xl font-bold mb-6">3. Pricing tiers linked to mandate profile</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <Card className="p-6 bg-card/50">
              <h3 className="text-lg font-bold mb-4 text-primary">Tier 1 – Standard Mandate</h3>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-xl font-bold text-primary">10 bps</p>
            ...
            <Card className="p-6 bg-card/50 border-primary/50">
              <h3 className="text-lg font-bold mb-4 text-primary">Tier 2 – Intermediate Mandate</h3>
              <p className="text-muted-foreground mb-6 min-h-[100px]">
              ...
              <div className="space-y-3">
                <div>
                  <p className="font-semibold">Recurring fee:</p>
                  <p className="text-xl font-bold text-primary">15 bps</p>
                  <p className="text-sm text-muted-foreground">on AUM from Introduced Investors</p>
                </div>
                <div>
                  <p className="font-semibold">Success fee:</p>
            ...
            <Card className="p-6 bg-card/50">
              <h3 className="text-lg font-bold mb-4 text-primary">Tier 3 – Complex Mandate</h3>
              <p className="text-muted-foreground mb-6 min-h-[100px]">
        ...
        <motion.section
          ...
          className="mb-16"
        >
          <h2 className="text-2xl font-bold mb-6">4. Why this model creates value for GPs</h2>
