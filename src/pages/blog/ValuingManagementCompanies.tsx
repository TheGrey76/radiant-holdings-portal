...
const ValuingManagementCompanies = () => {
  const articleUrl = "https://www.aries76.com/blog/valuing-management-companies";
  const articleTitle = "Valuing Management Companies: Beyond AUM and Carry";
  const articleDescription = "Traditional valuation metrics don't capture the full picture of a modern GP platform.";
  ...
  return (
    <div className="min-h-screen bg-background pt-24 pb-20">
      <Helmet>
        ...
        <meta property="article:published_time" content="2025-09-20T09:00:00+00:00" />
        <meta property="article:modified_time" content="2025-09-20T09:00:00+00:00" />
          ...
          >
            ...
            <div className="flex items-center gap-4 text-sm text-muted-foreground mb-12">
              <div className="flex items-center gap-2">
                ...
                <time dateTime="2025-09-20T09:00:00+00:00">September 20, 2025</time>
              </div>
              <span>•</span>
