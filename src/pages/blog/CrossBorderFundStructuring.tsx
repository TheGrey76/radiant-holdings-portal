...
const CrossBorderFundStructuring = () => {
  useEffect(() => {
    ...
    script.innerHTML = JSON.stringify({
      ...
      "@type": "Article",
      "headline": "Cross-Border Fund Structuring: Luxembourg vs. Ireland vs. UK",
      "description": "A comparative analysis of fund domicile options for European GPs raising global capital. Tax considerations, regulatory frameworks examined.",
      "author": {
        "@type": "Organization",
        "name": "Aries76 Ltd"
      },
