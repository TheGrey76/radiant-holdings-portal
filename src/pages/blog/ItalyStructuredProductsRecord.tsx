    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-4xl mx-auto px-6 py-24">
        ...
        >
          ...
          <div className="flex items-center gap-6 text-sm text-muted-foreground font-light mb-8 pb-8 border-b border-border">
          ...
          <div className="mt-12 space-y-8">
            ...
            <section>
            <h2 className="text-2xl font-light tracking-tight text-foreground">Record-Breaking Performance</h2>
            ...
            <section>
            <h2 className="text-2xl font-light tracking-tight text-foreground">Product Innovation and Diversity</h2>
            <p className="text-base font-light text-muted-foreground leading-relaxed">
            ...
            <section>
            <h2 className="text-2xl font-light tracking-tight text-foreground">Market Maturity and Investor Sophistication</h2>
            <p className="text-base font-light text-muted-foreground leading-relaxed">
            ...
            <section>
            <h2 className="text-2xl font-light tracking-tight text-foreground">Structural Drivers of Growth</h2>
            <p className="text-base font-light text-muted-foreground leading-relaxed">
              Several factors are contributing to the sustained expansion of Italy's structured products market:
            </p>
            <ul className="space-y-3 mt-4">
              <li className="text-base font-light text-muted-foreground leading-relaxed pl-4 border-l-2 border-accent/30">
                <strong className="text-foreground font-normal">Regulatory Evolution:</strong> Enhanced regulatory frameworks have increased transparency 
                and investor protection, building confidence in the asset class.
              </li>
              <li className="text-base font-light text-muted-foreground leading-relaxed pl-4 border-l-2 border-accent/30">
                <strong className="text-foreground font-normal">Product Innovation:</strong> Issuers are continuously developing new structures that address 
                specific investor needs and market conditions, from capital protection to participation in thematic opportunities.
              </li>
              <li className="text-base font-light text-muted-foreground leading-relaxed pl-4 border-l-2 border-accent/30">
                <strong className="text-foreground font-normal">Distribution Network:</strong> Italian banks and wealth managers have increasingly integrated 
                structured products into their advisory practices, improving access for retail and private banking clients.
              </li>
              <li className="text-base font-light text-muted-foreground leading-relaxed pl-4 border-l-2 border-accent/30">
                <strong className="text-foreground font-normal">Yield Environment:</strong> In a complex interest rate environment, structured products offer 
            ...
            <section>
            <h2 className="text-2xl font-light tracking-tight text-foreground">European Context and Competitive Position</h2>
            <p className="text-base font-light text-muted-foreground leading-relaxed">
            ...
            <section>
            <h2 className="text-2xl font-light tracking-tight text-foreground">Implications for Issuers and Distributors</h2>
            <p className="text-base font-light text-muted-foreground leading-relaxed">
            ...
            <ul className="space-y-3 mt-4">
              <li className="text-base font-light text-muted-foreground leading-relaxed pl-4 border-l-2 border-accent/30">
                <strong className="text-foreground font-normal">Market Opportunity:</strong> The consistent growth and record volumes demonstrate a large 
                and expanding addressable market for structured product issuers.
              </li>
              <li className="text-base font-light text-muted-foreground leading-relaxed pl-4 border-l-2 border-accent/30">
                <strong className="text-foreground font-normal">Product Development:</strong> The increase in product count suggests continued appetite 
                for innovation and diversification within the structured products universe.
              </li>
              <li className="text-base font-light text-muted-foreground leading-relaxed pl-4 border-l-2 border-accent/30">
                <strong className="text-foreground font-normal">Distribution Partnerships:</strong> Success in this market requires robust distribution 
                capabilities and strong relationships with Italian banks and wealth managers.
              </li>
              <li className="text-base font-light text-muted-foreground leading-relaxed pl-4 border-l-2 border-accent/30">
                <strong className="text-foreground font-normal">Regulatory Compliance:</strong> Navigating the Italian regulatory environment and maintaining 
            ...
            <section>
            <h2 className="text-2xl font-light tracking-tight text-foreground">Looking Ahead</h2>
            <p className="text-base font-light text-muted-foreground leading-relaxed">
            ...
            <div className="mt-16 p-8 bg-accent/5 border border-accent/20 rounded-lg">
              ...
              <Link 
                ...
                className="inline-flex items-center gap-2 text-accent hover:text-accent/80 font-light transition-colors"
              >
