...
const PrivateEquityFundraisingTrends2026 = () => {
  return (
    <BlogLayout
      ...
      description="Discover the five fundamental trends transforming PE fundraising in 2026. From GP capital advisory to AI adoption, learn how to navigate the new fundraising paradigm."
